                        ...
                        <div class="col-md-9">
                            <div class="row tile_count">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-6 tile_stats_count">
                                    <span class="count_top"><i class="fa fa-envelope-square"></i> Surat Peringatan
                                        1</span>
                                    <div class="count">
                            ...
                            ?>
                                    ...
                                    <span class="count_bottom"><button type="button" class="btn btn-warning btn-xs"
                                            data-toggle="modal" data-target=".cetaksp1">SP 1 Perlu
                                            Dicetak</button></span>
                                </div>
                                <!-- Penutup SP 1 -->
                                ...
                                <div class="modal fade cetaksp1" tabindex="-1" role="dialog" aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="myModalLabel">
                                                    <font color="#da3131"><b>Daftar Surat Peringatan (SP 1) Yang Harus
                                                            Dicetak</b></font>
                                                </h4>
                                            </div>
                                  ...
                                  ?>
                                                    <tr>
                                                        <td><?php echo $no; ?></td>
                                                        <td><?php echo "<b>Nama:</b> (".$cetak1['nis'].") ".$cetak1['nama_siswa']; ?>
                                                        </td>
                                                        <td><?php echo "<b>Kelas:</b> ".$cetak1['tingkat_kelas']." ".$cetak1['nama_jurusan']." ".$cetak1['sub_kelas']; ?>
                                                        </td>
                                                        <td><?php echo "<b>Total Poin:</b> ".$cetak1['jml_poin_pelanggaran']; ?>
                                                        </td>
                                                        <td>
                                                            <a
                                                                href="main.php?module=detail_siswa&nis=<?php echo $cetak1['nis']; ?>&sb=home">
                                                                <button type="button" class="btn btn-info btn-xs"><i
                                                                        class='fa fa-eye'></i> Lihat</button>
                                                            </a>
                                                            <a
                                                                href="main.php?module=pre_cetak1&nis=<?php echo $cetak1['nis']; ?>&id_temp_sp_1=<?php echo $cetak1['id_temp_sp_1']; ?>">
                                  ...
                                  ?>
                                                    <tr>
                                                        <td><?php echo $urut; ?></td>
                                                        <td><?php echo "<b>Nama:</b> (".$ulang1['nis'].") ".$ulang1['nama_siswa']; ?>
                                                        </td>
                                                        <td><?php echo "<b>Kelas:</b> ".$ulang1['tingkat_kelas']." ".$ulang1['nama_jurusan']." ".$ulang1['sub_kelas']; ?>
                                                        </td>
                                                        <td><?php echo "<b>Total Poin:</b> ".$ulang1['jml_poin_pelanggaran']; ?>
                                                        </td>
                                                        <td>
                                                            <a
                                                                href="main.php?module=pre_cetak1&nis=<?php echo $ulang1['nis']; ?>&id_temp_sp_1=<?php echo $ulang1['id_temp_sp_1']; ?>">
                                                                <button type="button" class="btn btn-primary btn-xs"><i
                            ...
                            ?>
                                    ...
                                    <span class="count_bottom"><button type="button" class="btn btn-warning btn-xs"
                                            data-toggle="modal" data-target=".cetaksp2">SP 2 Perlu
                                            Dicetak</button></span>
                                </div>
                                <!-- Penutup SP 2 -->
                                ...
                                <div class="modal fade cetaksp2" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="myModalLabel">
                                                    <font color="#da3131"><b>Daftar Surat Peringatan (SP 2) Yang Harus
                                                            Dicetak</b></font>
                                                </h4>
                                            </div>
                                            <div class="modal-body">
                                  ...
                                  ?>
                                                    <tr>
                                                        <td><?php echo $no; ?></td>
                                                        <td><?php echo "<b>Nama:</b> (".$cetak2['nis'].") ".$cetak2['nama_siswa']; ?>
                                                        </td>
                                                        <td><?php echo "<b>Kelas:</b> ".$cetak2['tingkat_kelas']." ".$cetak2['nama_jurusan']." ".$cetak2['sub_kelas']; ?>
                                                        </td>
                                                        <td><?php echo "<b>Total Poin:</b> ".$cetak2['jml_poin_pelanggaran']; ?>
                                                        </td>
                                                        <td>
                                                            <a
                                                                href="main.php?module=detail_siswa&nis=<?php echo $cetak2['nis']; ?>&sb=home">
                                                                <button type="button" class="btn btn-info btn-xs"><i
                                                                        class='fa fa-eye'></i> Lihat</button>
                                                            </a>
                                                            <a
                                                                href="main.php?module=pre_cetak2&nis=<?php echo $cetak2['nis']; ?>&id_temp_sp_2=<?php echo $cetak2['id_temp_sp_2']; ?>">
                                                                <button type="button" class="btn btn-primary btn-xs"><i
                                                                        class='fa fa-print'></i> Cetak</button>
                                                            </a>
                                                        </td>
                                  ...
                                  ?>
                                                    <tr>
                                                        <td><?php echo $urut; ?></td>
                                                        <td><?php echo "<b>Nama:</b> (".$ulang2['nis'].") ".$ulang2['nama_siswa']; ?>
                                                        </td>
                                                        <td><?php echo "<b>Kelas:</b> ".$ulang2['tingkat_kelas']." ".$ulang2['nama_jurusan']." ".$ulang2['sub_kelas']; ?>
                                                        </td>
                                                        <td><?php echo "<b>Total Poin:</b> ".$ulang2['jml_poin_pelanggaran']; ?>
                                                        </td>
                                                        <td>
                                                            <a
                                                                href="main.php?module=pre_cetak2&nis=<?php echo $ulang2['nis']; ?>&id_temp_sp_2=<?php echo $ulang2['id_temp_sp_2']; ?>">
                                                                <button type="button" class="btn btn-primary btn-xs"><i
                                                                        class='fa fa-print'></i> Cetak Ulang</button>
                                                            </a>
                                                        </td>
                            ...
                            ?>
                                    ...
                                    <span class="count_bottom"><button type="button" class="btn btn-warning btn-xs"
                                            data-toggle="modal" data-target=".cetaksp3">SP 3 Perlu
                                            Dicetak</button></span>
                                </div>
                                <!-- Penutup SP 3 -->
                                ...
                                <div class="modal fade cetaksp3" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="myModalLabel">
                                                    <font color="#da3131"><b>Daftar Surat Peringatan (SP 3) Yang Harus
                                                            Dicetak</b></font>
                                                </h4>
                                            </div>
                                            <div class="modal-body">
                                  ...
                                  ?>
                                                    <tr>
                                                        <td><?php echo $no; ?></td>
                                                        <td><?php echo "<b>Nama:</b> (".$cetak3['nis'].") ".$cetak3['nama_siswa']; ?>
                                                        </td>
                                                        <td><?php echo "<b>Kelas:</b> ".$cetak3['tingkat_kelas']." ".$cetak3['nama_jurusan']." ".$cetak3['sub_kelas']; ?>
                                                        </td>
                                                        <td><?php echo "<b>Total Poin:</b> ".$cetak3['jml_poin_pelanggaran']; ?>
                                                        </td>
                                                        <td>
                                                            <a
                                                                href="main.php?module=detail_siswa&nis=<?php echo $cetak3['nis']; ?>&sb=home">
                                                                <button type="button" class="btn btn-info btn-xs"><i
                                                                        class='fa fa-eye'></i> Lihat</button>
                                                            </a>
                                                            <a
                                                                href="main.php?module=pre_cetak3&nis=<?php echo $cetak3['nis']; ?>&id_temp_sp_3=<?php echo $cetak3['id_temp_sp_3']; ?>">
                                                                <button type="button" class="btn btn-primary btn-xs"><i
                                                                        class='fa fa-print'></i> Cetak</button>
                                                            </a>
                                                        </td>
                                  ...
                                  ?>
                                                    <tr>
                                                        <td><?php echo $urut; ?></td>
                                                        <td><?php echo "<b>Nama:</b> (".$ulang3['nis'].") ".$ulang3['nama_siswa']; ?>
                                                        </td>
                                                        <td><?php echo "<b>Kelas:</b> ".$ulang3['tingkat_kelas']." ".$ulang3['nama_jurusan']." ".$ulang3['sub_kelas']; ?>
                                                        </td>
                                                        <td><?php echo "<b>Total Poin:</b> ".$ulang3['jml_poin_pelanggaran']; ?>
                                                        </td>
                                                        <td>
                                                            <a
                                                                href="main.php?module=pre_cetak3&nis=<?php echo $ulang3['nis']; ?>&id_temp_sp_3=<?php echo $ulang3['id_temp_sp_3']; ?>">
                                                                <button type="button" class="btn btn-primary btn-xs"><i
                                                                        class='fa fa-print'></i> Cetak Ulang</button>
                                                            </a>
                                                        </td>
                            ...
                            ?>
                                    ...
                                    <span class="count_bottom"><button type="button" class="btn btn-warning btn-xs"
                                            data-toggle="modal" data-target=".rapat">Perlu Dirapatkan</button></span>
                                </div>
                                ...
                                <div class="modal fade rapat" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="myModalLabel">
                                                    <font color="#da3131"><b>Daftar Yang Harus Dirapatkan</b></font>
                                                </h4>
                                            </div>
                                            <div class="modal-body">
                                  ...
                                  ?>
                                                    <tr>
                                                        <td><?php echo $no; ?></td>
                                                        <td><?php echo "<b>Nama:</b> (".$rapat['nis'].") ".$rapat['nama_siswa']; ?>
                                                        </td>
                                                        <td><?php echo "<b>Kelas:</b> ".$rapat['tingkat_kelas']." ".$rapat['nama_jurusan']." ".$rapat['sub_kelas']; ?>
                                                        </td>
                                                        <td><?php echo "<b>Total Poin:</b> ".$rapat['jml_poin_pelanggaran']; ?>
                                                        </td>
                                                        <td>
                                                            <button type="button" class="btn btn-primary btn-xs"><i
                                                                    class='fa fa-print'></i> Sudah Rapat</button>
                                                        </td>
                                                    </tr>
                                                    <?php 
                                    $no++;
                            ...
                            <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <div class="tile-stats">
                                    ...
                                    <button type="button" class="btn btn-primary" data-toggle="modal"
                                        data-target=".th_ajaran" style="margin-left: 55px">Ganti Tahun Ajaran</button>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form method="post" action="module/th_ajaran/update_data.php">
                                                    <div class="modal-body">
                                                        ...
                                                        <input type="hidden" name="idThAjaran"
                                                            value="<?php echo $idThAjaran; ?>">
                                                        <input type="text" name="thAjaran"
                                                            placeholder="<?php echo $th_ajaran; ?>">
                            ...
                            <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                    <li role="presentation" class="active"><a href="#tab_content1" id="home-tab"
                                            role="tab" data-toggle="tab" aria-expanded="true">Pelanggaran</a>
                                    </li>
                                    <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab"
                                            data-toggle="tab" aria-expanded="false">Prestasi</a>
                                    </li>
                                </ul>
                                ...
                                <div id="myTabContent" class="tab-content">
                                  ...
                                  ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $dp['tingkat_kelas']." ".$dp['nama_jurusan']." ".$dp['sub_kelas']; ?>
                                                    </td>
