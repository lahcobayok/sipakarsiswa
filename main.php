...
<body class="nav-md">
                ...
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="main.php?module=home" class="site_title">
                            <div class="logo_pic"><img src="images/logo.png" class="img-lgkrn logo_img"></div>
                            <span>Dashboard</span>
                        </a>
                    </div>
    ...
    $(document).ready(function() {
        <?php
        include "lib/koneksi.php";
        //datapatkan data yang cocok dari tabel keterampilan
    ...
    $(document).ready(function() {
        ...
        Morris.Bar({
            ...
            data: [
                ...
                {
                    device: 'Juli',
                    geekbench: <?php $plg7=mysqli_fetch_array($plgJul); if($plg7['jumlah_data']==""){echo "0";} else {echo $plg7['jumlah_data'];} ?>
                },
                {
                    device: 'Agustus',
                    geekbench: <?php $plg8=mysqli_fetch_array($plgAgu); if($plg8['jumlah_data']==""){echo "0";} else {echo $plg8['jumlah_data'];} ?>
                },
                {
                    device: 'September',
                    geekbench: <?php $plg9=mysqli_fetch_array($plgSep); if($plg9['jumlah_data']==""){echo "0";} else {echo $plg9['jumlah_data'];} ?>
                },
                {
                    device: 'Oktober',
                    geekbench: <?php $plg10=mysqli_fetch_array($plgOkt); if($plg10['jumlah_data']==""){echo "0";} else {echo $plg10['jumlah_data'];} ?>
                },
                {
                    device: 'November',
                    geekbench: <?php $plg11=mysqli_fetch_array($plgNov); if($plg11['jumlah_data']==""){echo "0";} else {echo $plg11['jumlah_data'];} ?>
                },
                {
                    device: 'Desember',
                    geekbench: <?php $plg12=mysqli_fetch_array($plgDes); if($plg12['jumlah_data']==""){echo "0";} else {echo $plg12['jumlah_data'];} ?>
                },
                {
                    device: 'Januari',
                    geekbench: <?php $plg1=mysqli_fetch_array($plgJan); if($plg1['jumlah_data']==""){echo "0";} else {echo $plg1['jumlah_data'];} ?>
                },
                {
                    device: 'Februari',
                    geekbench: <?php $plg2=mysqli_fetch_array($plgFeb); if($plg2['jumlah_data']==""){echo "0";} else {echo $plg2['jumlah_data'];} ?>
                },
                {
                    device: 'Maret',
                    geekbench: <?php $plg3=mysqli_fetch_array($plgMar); if($plg3['jumlah_data']==""){echo "0";} else {echo $plg3['jumlah_data'];} ?>
                },
                {
                    device: 'April',
                    geekbench: <?php $plg4=mysqli_fetch_array($plgApr); if($plg4['jumlah_data']==""){echo "0";} else {echo $plg4['jumlah_data'];} ?>
                },
                {
                    device: 'Mei',
                    geekbench: <?php $plg5=mysqli_fetch_array($plgMei); if($plg5['jumlah_data']==""){echo "0";} else {echo $plg5['jumlah_data'];} ?>
                },
                {
                    device: 'Juni',
                    geekbench: <?php $plg6=mysqli_fetch_array($plgJun); if($plg6['jumlah_data']==""){echo "0";} else {echo $plg6['jumlah_data'];} ?>
                }
            ],
            xkey: 'device',
            ykeys: ['geekbench'],
        ...
        Morris.Bar({
            ...
            data: [
                ...
                {
                    device: 'Juli',
                    geekbench: <?php $pres7=mysqli_fetch_array($presJul); if($pres7['jumlah_data']==""){echo "0";} else {echo $pres7['jumlah_data'];} ?>
                },
                {
                    device: 'Agustus',
                    geekbench: <?php $pres8=mysqli_fetch_array($presAgu); if($pres8['jumlah_data']==""){echo "0";} else {echo $pres8['jumlah_data'];} ?>
                },
                {
                    device: 'September',
                    geekbench: <?php $pres9=mysqli_fetch_array($presSep); if($pres9['jumlah_data']==""){echo "0";} else {echo $pres9['jumlah_data'];} ?>
                },
                {
                    device: 'Oktober',
                    geekbench: <?php $pres10=mysqli_fetch_array($presOkt); if($pres10['jumlah_data']==""){echo "0";} else {echo $pres10['jumlah_data'];} ?>
                },
                {
                    device: 'November',
                    geekbench: <?php $pres11=mysqli_fetch_array($presNov); if($pres11['jumlah_data']==""){echo "0";} else {echo $pres11['jumlah_data'];} ?>
                },
                {
                    device: 'Desember',
                    geekbench: <?php $pres12=mysqli_fetch_array($presDes); if($pres12['jumlah_data']==""){echo "0";} else {echo $pres12['jumlah_data'];} ?>
                },
                {
                    device: 'Januari',
                    geekbench: <?php $pres1=mysqli_fetch_array($presJan); if($pres1['jumlah_data']==""){echo "0";} else {echo $pres1['jumlah_data'];} ?>
                },
                {
                    device: 'Februari',
                    geekbench: <?php $pres2=mysqli_fetch_array($presFeb); if($pres2['jumlah_data']==""){echo "0";} else {echo $pres2['jumlah_data'];} ?>
                },
                {
                    device: 'Maret',
                    geekbench: <?php $pres3=mysqli_fetch_array($presMar); if($pres3['jumlah_data']==""){echo "0";} else {echo $pres3['jumlah_data'];} ?>
                },
                {
                    device: 'April',
                    geekbench: <?php $pres4=mysqli_fetch_array($presApr); if($pres4['jumlah_data']==""){echo "0";} else {echo $pres4['jumlah_data'];} ?>
                },
                {
                    device: 'Mei',
                    geekbench: <?php $pres5=mysqli_fetch_array($presMei); if($pres5['jumlah_data']==""){echo "0";} else {echo $pres5['jumlah_data'];} ?>
                },
                {
                    device: 'Juni',
                    geekbench: <?php $pres6=mysqli_fetch_array($presJun); if($pres6['jumlah_data']==""){echo "0";} else {echo $pres6['jumlah_data'];} ?>
                }
            ],
            xkey: 'device',
            ykeys: ['geekbench'],
        ...
        Morris.Bar({
            ...
            data: [
                ...
                {
                    device: 'Juli',
                    geekbench: <?php $plg72=mysqli_fetch_array($plgJul2); if($plg72['jumlah_data']==""){echo "0";} else {echo $plg72['jumlah_data'];} ?>
                },
                {
                    device: 'Agustus',
                    geekbench: <?php $plg82=mysqli_fetch_array($plgAgu2); if($plg82['jumlah_data']==""){echo "0";} else {echo $plg82['jumlah_data'];} ?>
                },
                {
                    device: 'September',
                    geekbench: <?php $plg92=mysqli_fetch_array($plgSep2); if($plg92['jumlah_data']==""){echo "0";} else {echo $plg92['jumlah_data'];} ?>
                },
                {
                    device: 'Oktober',
                    geekbench: <?php $plg102=mysqli_fetch_array($plgOkt2); if($plg102['jumlah_data']==""){echo "0";} else {echo $plg102['jumlah_data'];} ?>
                },
                {
                    device: 'November',
                    geekbench: <?php $plg112=mysqli_fetch_array($plgNov2); if($plg112['jumlah_data']==""){echo "0";} else {echo $plg112['jumlah_data'];} ?>
                },
                {
                    device: 'Desember',
                    geekbench: <?php $plg122=mysqli_fetch_array($plgDes2); if($plg122['jumlah_data']==""){echo "0";} else {echo $plg122['jumlah_data'];} ?>
                },
                {
                    device: 'Januari',
                    geekbench: <?php $plg12=mysqli_fetch_array($plgJan2); if($plg12['jumlah_data']==""){echo "0";} else {echo $plg12['jumlah_data'];} ?>
                },
                {
                    device: 'Februari',
                    geekbench: <?php $plg22=mysqli_fetch_array($plgFeb2); if($plg22['jumlah_data']==""){echo "0";} else {echo $plg22['jumlah_data'];} ?>
                },
                {
                    device: 'Maret',
                    geekbench: <?php $plg32=mysqli_fetch_array($plgMar2); if($plg32['jumlah_data']==""){echo "0";} else {echo $plg32['jumlah_data'];} ?>
                },
                {
                    device: 'April',
                    geekbench: <?php $plg42=mysqli_fetch_array($plgApr2); if($plg42['jumlah_data']==""){echo "0";} else {echo $plg42['jumlah_data'];} ?>
                },
                {
                    device: 'Mei',
                    geekbench: <?php $plg52=mysqli_fetch_array($plgMei2); if($plg52['jumlah_data']==""){echo "0";} else {echo $plg52['jumlah_data'];} ?>
                },
                {
                    device: 'Juni',
                    geekbench: <?php $plg62=mysqli_fetch_array($plgJun2); if($plg62['jumlah_data']==""){echo "0";} else {echo $plg62['jumlah_data'];} ?>
                }
            ],
            xkey: 'device',
            ykeys: ['geekbench'],
        ...
        Morris.Bar({
            ...
            data: [
                ...
                {
                    device: 'Juli',
                    geekbench: <?php $pres72=mysqli_fetch_array($presJul2); if($pres72['jumlah_data']==""){echo "0";} else {echo $pres72['jumlah_data'];} ?>
                },
                {
                    device: 'Agustus',
                    geekbench: <?php $pres82=mysqli_fetch_array($presAgu2); if($pres82['jumlah_data']==""){echo "0";} else {echo $pres82['jumlah_data'];} ?>
                },
                {
                    device: 'September',
                    geekbench: <?php $pres92=mysqli_fetch_array($presSep2); if($pres92['jumlah_data']==""){echo "0";} else {echo $pres92['jumlah_data'];} ?>
                },
                {
                    device: 'Oktober',
                    geekbench: <?php $pres102=mysqli_fetch_array($presOkt2); if($pres102['jumlah_data']==""){echo "0";} else {echo $pres102['jumlah_data'];} ?>
                },
                {
                    device: 'November',
                    geekbench: <?php $pres112=mysqli_fetch_array($presNov2); if($pres112['jumlah_data']==""){echo "0";} else {echo $pres112['jumlah_data'];} ?>
                },
                {
                    device: 'Desember',
                    geekbench: <?php $pres122=mysqli_fetch_array($presDes2); if($pres122['jumlah_data']==""){echo "0";} else {echo $pres122['jumlah_data'];} ?>
                },
                {
                    device: 'Januari',
                    geekbench: <?php $pres12=mysqli_fetch_array($presJan2); if($pres12['jumlah_data']==""){echo "0";} else {echo $pres12['jumlah_data'];} ?>
                },
                {
                    device: 'Februari',
                    geekbench: <?php $pres22=mysqli_fetch_array($presFeb2); if($pres22['jumlah_data']==""){echo "0";} else {echo $pres22['jumlah_data'];} ?>
                },
                {
                    device: 'Maret',
                    geekbench: <?php $pres32=mysqli_fetch_array($presMar2); if($pres32['jumlah_data']==""){echo "0";} else {echo $pres32['jumlah_data'];} ?>
                },
                {
                    device: 'April',
                    geekbench: <?php $pres42=mysqli_fetch_array($presApr2); if($pres42['jumlah_data']==""){echo "0";} else {echo $pres42['jumlah_data'];} ?>
                },
                {
                    device: 'Mei',
                    geekbench: <?php $pres52=mysqli_fetch_array($presMei2); if($pres52['jumlah_data']==""){echo "0";} else {echo $pres52['jumlah_data'];} ?>
                },
                {
                    device: 'Juni',
                    geekbench: <?php $pres62=mysqli_fetch_array($presJun2); if($pres62['jumlah_data']==""){echo "0";} else {echo $pres62['jumlah_data'];} ?>
                }
            ],
            xkey: 'device',
            ykeys: ['geekbench'],
        ...
        Morris.Bar({
            ...
            data: [
                ...
                {
                    device: 'Juli',
                    geekbench: <?php $plg73=mysqli_fetch_array($plgJul3); if($plg73['jumlah_data']==""){echo "0";} else {echo $plg73['jumlah_data'];} ?>
                },
                {
                    device: 'Agustus',
                    geekbench: <?php $plg83=mysqli_fetch_array($plgAgu3); if($plg83['jumlah_data']==""){echo "0";} else {echo $plg83['jumlah_data'];} ?>
                },
                {
                    device: 'September',
                    geekbench: <?php $plg93=mysqli_fetch_array($plgSep3); if($plg93['jumlah_data']==""){echo "0";} else {echo $plg93['jumlah_data'];} ?>
                },
                {
                    device: 'Oktober',
                    geekbench: <?php $plg103=mysqli_fetch_array($plgOkt3); if($plg103['jumlah_data']==""){echo "0";} else {echo $plg103['jumlah_data'];} ?>
                },
                {
                    device: 'November',
                    geekbench: <?php $plg113=mysqli_fetch_array($plgNov3); if($plg113['jumlah_data']==""){echo "0";} else {echo $plg113['jumlah_data'];} ?>
                },
                {
                    device: 'Desember',
                    geekbench: <?php $plg123=mysqli_fetch_array($plgDes3); if($plg123['jumlah_data']==""){echo "0";} else {echo $plg123['jumlah_data'];} ?>
                },
                {
                    device: 'Januari',
                    geekbench: <?php $plg13=mysqli_fetch_array($plgJan3); if($plg13['jumlah_data']==""){echo "0";} else {echo $plg13['jumlah_data'];} ?>
                },
                {
                    device: 'Februari',
                    geekbench: <?php $plg23=mysqli_fetch_array($plgFeb3); if($plg23['jumlah_data']==""){echo "0";} else {echo $plg23['jumlah_data'];} ?>
                },
                {
                    device: 'Maret',
                    geekbench: <?php $plg33=mysqli_fetch_array($plgMar3); if($plg33['jumlah_data']==""){echo "0";} else {echo $plg33['jumlah_data'];} ?>
                },
                {
                    device: 'April',
                    geekbench: <?php $plg43=mysqli_fetch_array($plgApr3); if($plg43['jumlah_data']==""){echo "0";} else {echo $plg43['jumlah_data'];} ?>
                },
                {
                    device: 'Mei',
                    geekbench: <?php $plg53=mysqli_fetch_array($plgMei3); if($plg53['jumlah_data']==""){echo "0";} else {echo $plg53['jumlah_data'];} ?>
                },
                {
                    device: 'Juni',
                    geekbench: <?php $plg63=mysqli_fetch_array($plgJun3); if($plg63['jumlah_data']==""){echo "0";} else {echo $plg63['jumlah_data'];} ?>
                }
            ],
            xkey: 'device',
            ykeys: ['geekbench'],
        ...
        Morris.Bar({
            ...
            data: [
                ...
                {
                    device: 'Juli',
                    geekbench: <?php $pres73=mysqli_fetch_array($presJul3); if($pres73['jumlah_data']==""){echo "0";} else {echo $pres73['jumlah_data'];} ?>
                },
                {
                    device: 'Agustus',
                    geekbench: <?php $pres83=mysqli_fetch_array($presAgu3); if($pres83['jumlah_data']==""){echo "0";} else {echo $pres83['jumlah_data'];} ?>
                },
                {
                    device: 'September',
                    geekbench: <?php $pres93=mysqli_fetch_array($presSep3); if($pres93['jumlah_data']==""){echo "0";} else {echo $pres93['jumlah_data'];} ?>
                },
                {
                    device: 'Oktober',
                    geekbench: <?php $pres103=mysqli_fetch_array($presOkt3); if($pres103['jumlah_data']==""){echo "0";} else {echo $pres103['jumlah_data'];} ?>
                },
                {
                    device: 'November',
                    geekbench: <?php $pres113=mysqli_fetch_array($presNov3); if($pres113['jumlah_data']==""){echo "0";} else {echo $pres113['jumlah_data'];} ?>
                },
                {
                    device: 'Desember',
                    geekbench: <?php $pres123=mysqli_fetch_array($presDes3); if($pres123['jumlah_data']==""){echo "0";} else {echo $pres123['jumlah_data'];} ?>
                },
                {
                    device: 'Januari',
                    geekbench: <?php $pres13=mysqli_fetch_array($presJan3); if($pres13['jumlah_data']==""){echo "0";} else {echo $pres13['jumlah_data'];} ?>
                },
                {
                    device: 'Februari',
                    geekbench: <?php $pres23=mysqli_fetch_array($presFeb3); if($pres23['jumlah_data']==""){echo "0";} else {echo $pres23['jumlah_data'];} ?>
                },
                {
                    device: 'Maret',
                    geekbench: <?php $pres33=mysqli_fetch_array($presMar3); if($pres33['jumlah_data']==""){echo "0";} else {echo $pres33['jumlah_data'];} ?>
                },
                {
                    device: 'April',
                    geekbench: <?php $pres43=mysqli_fetch_array($presApr3); if($pres43['jumlah_data']==""){echo "0";} else {echo $pres43['jumlah_data'];} ?>
                },
                {
                    device: 'Mei',
                    geekbench: <?php $pres53=mysqli_fetch_array($presMei3); if($pres53['jumlah_data']==""){echo "0";} else {echo $pres53['jumlah_data'];} ?>
                },
                {
                    device: 'Juni',
                    geekbench: <?php $pres63=mysqli_fetch_array($presJun3); if($pres63['jumlah_data']==""){echo "0";} else {echo $pres63['jumlah_data'];} ?>
                }
            ],
            xkey: 'device',
            ykeys: ['geekbench'],
